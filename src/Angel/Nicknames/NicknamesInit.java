...
public class NicknamesInit implements Runnable {
    private final Logger log = LogManager.getLogger(NicknamesInit.class);
    ...
    public NicknamesInit(boolean commandsSuspended, MainConfiguration mainConfig, EmbedHandler embed, Guild guild, DiscordBotMain discord) {
